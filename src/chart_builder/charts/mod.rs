...
pub mod box_whisker_plot;

pub mod doughnut_chart;

pub mod pie_chart;

pub mod vertical_bar_chart;
...
pub(self) fn draw_legend(
    cr: &Context,
    legend_values: &Vec<String>,
    screen_size: (f64, f64),
    legend_size: f64,
) {
    ...
    for i in 0..legend_values.len() {
        ...
        cr.rectangle(
            ...
            0.5 - ((legend_values.len() as f64) * max_text_height * 1.5) / 2.0
                + (i as f64) * max_text_height * 1.5
                - max_text_height * 0.4,
