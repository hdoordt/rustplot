...
fn axis_value_crop_tests() {
    ...
    let bar4 = chart_builder::VerticalBarChart::new(
        String::from("Axis Crop Chart 4"),
        data_7.clone(),
        vec![data_8.clone()],
    );
    bar4.draw();
