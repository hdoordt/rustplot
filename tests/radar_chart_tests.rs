...
fn radar_chart_tests() {
    ...
    let radar = chart_builder::RadarChart::new(
        String::from("Test Radar Chart 1"),
        data_1.clone(),
        vec![data_2.clone()],
    );
    radar.draw();
    ...
    let radar = chart_builder::RadarChart::new(
        String::from("Test Radar Chart 2"),
        data_3.clone(),
        vec![data_4.clone()],
    );
    radar.draw();
    ...
    let radar = chart_builder::RadarChart::new(
        String::from("Test Radar Chart 3"),
        data_5.clone(),
        vec![data_6.clone()],
    );
    radar.draw();
    ...
    let radar = chart_builder::RadarChart::new(
        String::from("Test Radar Chart 4"),
        data_7.clone(),
        vec![data_8.clone()],
    );
    radar.draw();

    let mut radar = chart_builder::RadarChart::new(
        String::from("Test Radar Chart 5"),
        data_3.clone(),
        vec![data_9.clone(), data_10.clone(), data_11.clone()],
    );
    radar.chart_prop.set_legend_values(vec![
        String::from("Person 1"),
        String::from("Person 2"),
        String::from("Person 3"),
    ]);
