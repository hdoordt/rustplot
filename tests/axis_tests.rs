...
fn axis_tests() {
    ...
    chart_builder::XYScatterPlot::new(
        String::from("Test Axis 1"),
        vec![row_num_1.clone()],
        vec![row_num_2.clone()],
    )
    .draw();
