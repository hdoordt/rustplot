...
fn line_chart_tests() {
    ...
    let line1 = chart_builder::LineChart::new(
        String::from("Test Line Chart 1"),
        data_1.clone(),
        vec![data_2.clone()],
    );
    line1.draw();
    ...
    let line2 = chart_builder::LineChart::new(
        String::from("Test Line Chart 2"),
        data_3.clone(),
        vec![data_4.clone()],
    );
    line2.draw();
    ...
    let line3 = chart_builder::LineChart::new(
        String::from("Test Line Chart 3"),
        data_5.clone(),
        vec![data_6.clone()],
    );
    line3.draw();
    ...
    let mut multi_line_1 = chart_builder::LineChart::new(
        String::from("Test Line Chart 4"),
        data_1.clone(),
    ...
    multi_line_3.chart_prop.set_legend_values(vec![
        String::from("Location 1"),
        String::from("Location 2"),
        String::from("Location 3"),
    ]);
