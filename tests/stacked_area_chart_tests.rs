...
fn stacked_area_chart_tests() {
    ...
    let stacked_area1 = chart_builder::StackedAreaChart::new(
        String::from("Test Stacked Area Chart 1"),
        data_1.clone(),
        vec![data_2.clone()],
    );
    stacked_area1.draw();
    ...
    let stacked_area2 = chart_builder::StackedAreaChart::new(
        String::from("Test Stacked Area Chart 2"),
        data_3.clone(),
        vec![data_4.clone()],
    );
    stacked_area2.draw();
    ...
    let mut multi_stacked_area_1 = chart_builder::StackedAreaChart::new(
        String::from("Test Stacked Area Chart 3"),
        data_1.clone(),
        vec![data_7.clone(), data_8.clone(), data_9.clone()],
    );
    multi_stacked_area_1.chart_prop.set_show_legend(true);
    multi_stacked_area_1.chart_prop.set_legend_values(vec![
    ...
    let mut multi_stacked_area_1 = chart_builder::StackedAreaChart::new(
        String::from("Test Stacked Area Chart 4"),
        data_1.clone(),
