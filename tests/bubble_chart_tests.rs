...
fn bubble_chart_tests() {
    ...
    let mut multi_bubble = chart_builder::BubbleChart::new(
        String::from("Test Bubble Chart 1"),
        vec![data_1.clone()],
        vec![data_2.clone()],
        vec![data_3.clone()],
    );
    multi_bubble
        .axis_prop
        .set_x_axis_title(String::from("Temperature (C)"));
    multi_bubble
        .axis_prop
        .set_y_axis_title(String::from("Sales (£)"));
    multi_bubble.draw();
    ...
    let mut multi_bubble = chart_builder::BubbleChart::new(
        String::from("Test Bubble Chart 2"),
        vec![data_4.clone()],
        vec![data_5.clone()],
        vec![data_6.clone()],
    );
    ...
    let mut multi_bubble = chart_builder::BubbleChart::new(
        String::from("Test Bubble Chart 3"),
    ...
    let mut multi_bubble = chart_builder::BubbleChart::new(
        String::from("Test Bubble Chart 4"),
    ...
    multi_bubble
        .axis_prop
        .set_y_axis_title(String::from("Sales (£)"));
    multi_bubble.chart_prop.set_legend_values(vec![
