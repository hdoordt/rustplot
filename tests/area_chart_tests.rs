...
fn area_chart_tests() {
    ...
    let area1 = chart_builder::AreaChart::new(
        String::from("Test Area Chart 1"),
        data_1.clone(),
        vec![data_2.clone()],
    );
    area1.draw();
    ...
    let area2 = chart_builder::AreaChart::new(
        String::from("Test Area Chart 2"),
        data_3.clone(),
        vec![data_4.clone()],
    );
    area2.draw();
    ...
    let area3 = chart_builder::AreaChart::new(
        String::from("Test Area Chart 3"),
        data_5.clone(),
        vec![data_6.clone()],
    );
    area3.draw();
    ...
    let mut multi_area_1 = chart_builder::AreaChart::new(
        String::from("Test Area Chart 4"),
        data_1.clone(),
        vec![data_7.clone(), data_8.clone(), data_9.clone()],
    );
    multi_area_1.chart_prop.set_show_legend(true);
    multi_area_1.chart_prop.set_legend_values(vec![
    ...
    let mut multi_area_3 = chart_builder::AreaChart::new(
        String::from("Test Area Chart 6"),
        data_1.clone(),
        vec![data_2.clone(), data_4.clone(), data_6.clone()],
    );
    multi_area_3.chart_prop.set_show_legend(true);
    multi_area_3.chart_prop.set_legend_values(vec![
        String::from("Location 1"),
        String::from("Location 2"),
        String::from("Location 3"),
    ]);
