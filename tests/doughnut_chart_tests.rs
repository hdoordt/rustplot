...
fn doughnut_chart_tests() {
    ...
    let mut doughnut_chart = chart_builder::DoughnutChart::new(
        String::from("Test Doughnut Chart 1"),
        vec![data_2.clone(), data_3.clone()],
    );
    ...
    let mut doughnut_chart = chart_builder::DoughnutChart::new(
        String::from("Test Doughnut Chart 2"),
        vec![data_2.clone(), data_3.clone(), data_4.clone()],
    );
    doughnut_chart.chart_prop.set_legend_values(data_1.clone());
    doughnut_chart.chart_prop.set_show_legend(true);
    doughnut_chart.draw();
